...
class ImageTool {
    ...
    **/
    public static function thumb($dst,$save=NULL,$width=200,$height=200) {
        ...
        // 创建白色填充缩略画布
        //$white = imagecolorallocate($tim,0,0,0);
        $white = imagecolorallocatealpha($tim , 255 , 255 , 255 , 127);//拾取一个完全透明的颜色

        imagealphablending($tim , false);//关闭混合模式，以便透明颜色能覆盖原画布
        // 填充缩略画布
        ...
        imagesavealpha($tim , true);//设置保存PNG时保留透明通道信息  
